...
| :-------------------------------------------------------------: | :---------------------- | :----------- | :--------------------------------------------------------- | :--------------------------------------------------------------: |
|       <img src="previews/BEACH_PORTRAIT.jpg" width="160">       | **Beach Portrait**      | `PORTRAIT`   | Chân dung nắng biển, nâng sáng vùng tối                    |         [📥 Tải về](CUSTOMPC/BEACH_PORTRAIT.NCP)         |
|        <img src="previews/MOUNTAIN_SEA.jpg" width="160">        | **Mountain Sea**        | `LANDSCAPE`  | Phong cảnh núi biển trong vắt, độ tương phản và nét cao    |          [📥 Tải về](CUSTOMPC/MOUNTAIN_SEA.NCP)          |
|        <img src="previews/VINTAGE_LOOK.jpg" width="160">        | **Vintage Look**        | `NEUTRAL`    | Nước ảnh phim úa vàng ấm, phủ sương mờ (Matte shadow)      |          [📥 Tải về](CUSTOMPC/VINTAGE_LOOK.NCP)          |
|          <img src="previews/CINE_LOOK.jpg" width="160">         | **Cine Look**           | `STANDARD`   | Màu phim điện ảnh Teal & Orange trong trẻo                 |             [📥 Tải về](CUSTOMPC/CINE_LOOK.NCP)             |
|       <img src="previews/CLASSIC_CHROME.jpg" width="160">       | **Classic Chrome**      | `NEUTRAL`    | Giả lập màu Fujifilm Classic Chrome trầm mặc               |        [📥 Tải về](CUSTOMPC/CLASSIC_CHROME.NCP)        |
|         <img src="previews/STREET_MONO.jpg" width="160">        | **Street Mono**         | `MONOCHROME` | Đen trắng đường phố tương phản cực gắt kết hợp Kính lọc Đỏ |           [📥 Tải về](CUSTOMPC/STREET_MONO.NCP)           |
|       <img src="previews/KP160_CLEAR_NEG.jpg" width="160">      | **Clear Neg KP160**     | `PORTRAIT`   | Giả lập Kodak Portra 160: Tone da hồng hào, màu pastel dịu |        [📥 Tải về](CUSTOMPC/KP160_CLEAR_NEG.NCP)       |
|       <img src="previews/KE100_RICH_NEG.jpg" width="160">       | **Rich Neg KE100**      | `VIVID`      | Giả lập Kodak Ektar 100: Màu rực rỡ gắt gao cho phong cảnh |         [📥 Tải về](CUSTOMPC/KE100_RICH_NEG.NCP)        |
|       <img src="previews/KG200_WARM_NEG.jpg" width="160">       | **Warm Neg KG200**      | `STANDARD`   | Giả lập Kodak Gold 200: Tông vàng ấm áp cổ điển            |         [📥 Tải về](CUSTOMPC/KG200_WARM_NEG.NCP)        |
|      <img src="previews/NC100_CLASSIC_NEG.jpg" width="160">     | **Classic Neg NC100**   | `NEUTRAL`    | Giả lập Fujifilm Classic Negative (Superia): Shadows sâu   |      [📥 Tải về](CUSTOMPC/NC100_CLASSIC_NEG.NCP)     |
|      <img src="previews/CC200_CLASSIC_POS.jpg" width="160">     | **Classic Pos CC200**   | `NEUTRAL`    | Giả lập Fujifilm Classic Positive: Màu lặng sâu lắng       |      [📥 Tải về](CUSTOMPC/CC200_CLASSIC_POS.NCP)     |
|     <img src="previews/NN400_NOSTALGIC_NEG.jpg" width="160">    | **Nostalgic Neg NN400** | `NEUTRAL`    | Giả lập Fujifilm Nostalgic Neg: Tone hổ phách vàng ấm      |     [📥 Tải về](CUSTOMPC/NN400_NOSTALGIC_NEG.NCP)    |
